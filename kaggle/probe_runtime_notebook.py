# ==============================================================================
# AMSA-YOLO: Kaggle Runtime Environment Probe (Single-Cell Notebook Script)
# ==============================================================================
# Instructions:
# 1. Paste this ENTIRE block into a single code cell in your Kaggle Notebook.
# 2. Ensure Notebook settings:
#    - Accelerator: GPU (e.g. RTX PRO 6000 or assigned GPU)
#    - Internet: OFF
# 3. Run the cell and copy the entire output (especially the DECISION INPUTS block).
# ==============================================================================
